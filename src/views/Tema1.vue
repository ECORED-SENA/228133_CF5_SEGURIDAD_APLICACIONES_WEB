  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    .titulo-principal.color-acento-contenido
      .titulo-principal__numero
        span 1
      h1(data-aos="fade-right") Seguridad en Aplicaciones <em>Web</em>
    ...
    .bg_3.p-4.mb-4
      .row.justify-content-center.align-items-center
        ...
        .col-10.col-md-12.col-lg-10(data-aos="fade-right")
          ...
          | Y en parte esta idea puede ser transferida al contexto de un plan estratégico de seguridad en aplicaciones <em>web</em>.
